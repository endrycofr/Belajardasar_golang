...
func main() {
	...
	status, err := statusService.SetRepository(1) //memanggil method SetRepository dari struct UserService dan validasi error dan hasil tersimpan di variable status dan err
	if err != nil {
